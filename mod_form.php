...
class mod_coresurvey_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        //-------------------------------------------------------------------------------
        // Adding the rest of coresurvey settings, spreading all them into this fieldset
        // or adding more fieldsets ('header' elements) if needed for better logic
        //$mform->addElement('static', 'label1', 'coresurveysetting1', 'Your coresurvey fields go here. Replace me!');
